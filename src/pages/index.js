      ...
      <Layout>
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-0">
          ...
          <div className="mb-16">
            ...
            <iframe title="Spotify Player" src="https://open.spotify.com/embed/track/7E4zA9ThAPXPf8WMQpJuP5?theme=0" width="100%" height="380" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
          </div>
          <div>
            <h3 className="text-2xl my-4">SOUNDCLOUD</h3>
            <iframe title="SoundCloud Player" width="100%" height="166" scrolling="no" frameBorder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1090036762&color=%23000000&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe><div style={{fontSize: "10px;", color: "#cccccc;", lineBreak: "anywhere", wordBreak: "normal", overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis", fontFamily: "Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif", fontWeight: "100"}}><a href="https://soundcloud.com/moonstunes" title="d.chandler.moon" rel="noreferrer" target="_blank" style={{color: "#cccccc", textDecoration: "none"}}>d.chandler.moon</a> · <a href="https://soundcloud.com/moonstunes/still-mama-prays-3v11-anew-107" title="Still Mama Prays" rel="noreferrer" target="_blank" style={{color: "#cccccc", textDecoration: "none"}}>Still Mama Prays</a></div>
          </div>
        </div>
